export default function EngineRoomSettingsLoading() {
  return (
    <div className="max-w-4xl mx-auto px-6 md:px-10 pt-10 pb-16 animate-pulse">
      <div className="h-7 w-56 bg-white/10 rounded mb-3" />
      <div className="h-3 w-[90%] max-w-xl bg-white/5 rounded mb-10" />
